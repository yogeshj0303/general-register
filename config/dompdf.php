...
return [
    ...
    */
    ...
    'font_dir' => public_path('fonts/'), // Fonts stored in public directory
'font_cache' => public_path('fonts/'), // Cache directory




'default_font' => 'noto-sans-devanagari', // Default font name
