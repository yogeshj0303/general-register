        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">School Annual Maintenance</h4>
                </div><!-- end card header -->
                                ...
                                <tbody class="list form-check-all">
                                    @foreach($annualMaintenance as $record)
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success-subtle text-success text-uppercase">{{ $record->payment_mode }}</span></td>
...
<script>
  function printAffidavit(userId) {
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewCategoryModalLabel">School Annual Maintenance</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- Gram -->
                    <div class="col-md-6">
                        <label for="viewGram" class="form-label">School</label>
