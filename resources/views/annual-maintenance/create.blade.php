        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Add School Annual Maintenance</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('annual-maintenance.store') }}" method="POST">
                            ...
                            <div class="row gy-4">
                               ...
                               <div class="col-md-4">
    <label for="category_name" class="form-label">Select School</label>
...
<div class="col-md-4">
    ...
    <select class="form-control js-example-basic-single @error('maintenance_year') is-invalid @enderror" id="maintenance_year" name="maintenance_year">
...
<script>
    $(document).ready(function () {
        ...
        let isAdmin = @json(Auth::user()->is_admin === 'admin'); // Check if the user is an admin
        let userGram = @json(Auth::user()->gram); // Get the gram value for non-admin users
        ...
        function fetchMaintenanceData(gram) {
            $.ajax({
                url: "{{ route('get.maintenance.amount') }}",
                type: "POST",
                data: {
                    gram: gram,
                    _token: "{{ csrf_token() }}"
