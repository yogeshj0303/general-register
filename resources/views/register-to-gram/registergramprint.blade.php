...
<head>
    ...
    <title>REGISTER TO School REPORT</title>
    <style>
      @page {
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">REGISTER TO SCHOOL REPORT</h1>
          <div class="header-info">
                <h1 class="username" style="font-family: 'noto-sans-devanagari';">{{ $registerToGrams->gram }}</h1>
<p style="font-size: 1.2rem; line-height: 1.8; text-align: center;">
    <strong style="margin-right: 10px; color: #fff;">State:-</strong> {{ $registerToGrams->state }}
    <strong style="margin: 0 10px; color: #fff;">District:-</strong> {{ $registerToGrams->district }}
    <strong style="margin-left: 10px; color: #fff;">Taluka:-</strong> {{ $registerToGrams->taluka }}
</p>
        ...
        <table class="info-table" style="margin-top:40px">
            ...
            <tbody>
                ...
                <!--    <td>{{ $rowNumber++ }}</td>-->
                <!--    <td>State</td>-->
                <!--    <td>{{ $registerToGrams->state }}</td>-->
                <!--</tr>-->
                
                <!--                <tr>-->
                <!--    <td>{{ $rowNumber++ }}</td>-->
                <!--    <td>District</td>-->
                <!--    <td>{{ $registerToGrams->district }}</td>-->
                <!--</tr>-->
                <!--<tr>-->
                <!--    <td>{{ $rowNumber++ }}</td>-->
                <!--    <td>Taluka</td>-->
                <!--    <td>{{ $registerToGrams->taluka }}</td>-->
                <!--</tr>-->
                <!--<tr>-->
                <!--    <td>{{ $rowNumber++ }}</td>-->
                <!--    <td>Gram</td>-->
                <!--    <td>{{ $registerToGrams->gram }}</td>-->
                <!--</tr>-->
                
                <tr>
                    <td>{{ $rowNumber++ }}</td>
                    <td>Category</td>
                    <td>{{ $registerToGrams->category }}</td>
                </tr>
