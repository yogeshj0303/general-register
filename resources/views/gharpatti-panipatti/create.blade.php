                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control js-example-basic-single" id="username" name="username">
                                       @if(Auth::user()->is_admin === 'admin') <option value="">Select User Name</option> @endif
                                        <!-- Add options dynamically -->
                                    </select>
                                </div>
                                <div class="col-md-4">
...
$('#type, #username').on('change', function () {
 ...
 if (totalAmount === 0) {
        Swal.fire({
            ...
            window.location.href = '{{ route("gharpatti-panipatti.index") }}';
        });
...
$('#paid_amount').on('input', function () {
    ...
    <script>
    $(document).ready(function() {
        var user = @json(Auth::user()); // Pass Auth::user() data to JavaScript
    ...
    response.forEach(function(userData) {
         // Check if the user ID matches Auth::user()->id
            ...
            var statesData = @json($statesData['states']); // Pass states data
