...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    ($permissions['p_w_bill_add'] == 2)
                                    ...
                                    <a href="{{ route('gharpatti-panipatti.create') }}">
    ...
    ($permissions['p_w_bill_viewown'] == 2) || ($permissions['p_w_bill_viewall'] == 2)
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                          <td class="customer_name">{{ $record->id }}</td>
                                        <td class="customer_name">{{ $record->state }}</td>
                                        <td class="email">{{ $record->district }}</td>
                                        <td class="phone">{{ $record->taluka }}</td>
                                        <td class="date">{{ $record->gram }}</td>
                                        <td class="customer_name">{{ $record->user_name }}</td>
                                        <td class="type"><span class="badge bg-success-subtle text-success text-uppercase">
                                            @if($record->type == "gharpatti")
                                        ...
                                        <td class="amount_type"><span class="badge bg-success-subtle text-success text-uppercase">{{ $record->amount_type }}</span></td>
                                        <td class="paid_type"><span class="badge bg-success-subtle text-success text-uppercase">{{ $record->paid_type }}</span></td>
                                        <td class="paid_amount">{{ $record->paid_amount }}</td>
                                        <td class="paid_date">{{ $record->paid_date }}</td>
                                        <td>
    ...
    ($permissions['p_w_bill_edit'] == 2) 
                                                ...
                                                <div class="edit">
                                                    <a href="{{ route('gharpatti-panipatti.edit', $record->id) }}" class="btn btn-sm btn-primary">Edit</a>  </div>
                                                    @endif
                                                    @if((isset($permissions)) && (  
