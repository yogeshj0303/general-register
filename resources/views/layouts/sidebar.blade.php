        ...
        <div class="container-fluid">
           ...
           <ul class="navbar-nav" id="navbar-nav">
               ...
               ($permissions['m_taluka_add'] == 2) || ($permissions['m_taluka_edit'] == 2) || ($permissions['m_taluka_delete'] == 2) || ($permissions['m_taluka_viewown'] == 2) || ($permissions['m_taluka_viewall'] == 2) 
                            ...
                            <li class="nav-item">
                                <a href="{{ route('talukas.index') }}" class="nav-link">Manage Taluka</a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (
                  ($permissions['m_gram_add'] == 2) || ($permissions['m_gram_edit'] == 2) || ($permissions['m_gram_delete'] == 2) || ($permissions['m_gram_viewown'] == 2) || ($permissions['m_gram_viewall'] == 2)  
                            ...
                            <li class="nav-item">
                                <a href="{{ route('grams.index') }}" class="nav-link">Manage School</a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (
                  ($permissions['registered_gram_add'] == 2) || ($permissions['registered_gram_edit'] == 2) || ($permissions['registered_gram_delete'] == 2) || ($permissions['registered_gram_viewown'] == 2) || ($permissions['registered_gram_viewall'] == 2) ||($permissions['registered_gram_print'] == 2)  
                            ...
                            <li class="nav-item">
                                <a href="{{ route('register-to-gram.index') }}" class="nav-link">Add Register To School</a>
                            </li>
                            @endif
          ...
          @if((isset($permissions)) && (
               ...
               <li class="nav-item">
                ...
                @endif
                   ...
                   <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('lc.index') }}" >
              ...
              <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('bonafid.index') }}" >
              ...
              <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('gram-bills.index') }}" >
               ...
               <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('annual-maintenance.index') }}">
