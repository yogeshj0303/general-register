...
<body>
    ...
    <div class="container">
        <h1 class="page-title">POPULATION REPORT</h1>
                ...
                <h1 class="username" style="font-family: 'noto-sans-devanagari';">{{ $Population->gram }}</h1>
<p style="font-size: 1.2rem; line-height: 1.8; text-align: center;">
    <strong style="margin-right: 10px; color: #fff;">State:-</strong> {{ $Population->state }}
    <strong style="margin: 0 10px; color: #fff;">District:-</strong> {{ $Population->district }}
    <strong style="margin-left: 10px; color: #fff;">Taluka:-</strong> {{ $Population->taluka }}
</p>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <?php $confimed_name=DB::table('users')->where('id',$Population->confirm_by)->first();
                                     $role_name=DB::table('roles')->where('id',$confimed_name->user_type)->first();?> {{$confimed_name->name}} ({{$role_name->role_name}})</td>
                                   </td>
                </tr>
                   </tbody>
        </table>
