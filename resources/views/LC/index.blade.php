...
<table id="fixed-header" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
    ...
    <tbody>
        @foreach($lcs as $lc)
            <tr id="lcRow{{ $lc->id }}">
                <td>{{ isset($lc->id) ? $lc->id : 'N/A' }}</td>
                <td>{{ isset($lc->state) ? $lc->state : 'N/A' }}</td>
                <td>{{ isset($lc->district) ? $lc->district : 'N/A' }}</td>
                <td>{{ isset($lc->taluka) ? $lc->taluka : 'N/A' }}</td>
                <td>{{ isset($lc->grams->gram_name) ? $lc->grams->gram_name : 'N/A' }}</td>
                <td>{{ isset($lc->student_id) ? $lc->student_id : 'N/A' }}</td>
                                <td>{{ isset($lc->student_first_name) && isset($lc->student_middle_name) && isset($lc->student_last_name) ? $lc->student_first_name . ' ' . $lc->student_middle_name . ' ' . $lc->student_last_name : 'N/A' }}</td>

                <td>{{ isset($lc->adhar_number) ? $lc->adhar_number : 'N/A' }}</td>
                                <td>{{ isset($lc->other_studies) ? $lc->other_studies : 'N/A' }}</td>

                <td>{{ isset($lc->mother_name) ? $lc->mother_name : 'N/A' }}</td>
                <td>{{ isset($lc->nationality) ? $lc->nationality : 'N/A' }}</td>
                <!--<td>{{ isset($lc->mother_tongue) ? $lc->mother_tongue : 'N/A' }}</td>-->
                <td>{{ isset($lc->religion) ? $lc->religion : 'N/A' }}</td>
                <td>{{ isset($lc->caste) ? $lc->caste : 'N/A' }}</td>
                <!--<td>{{ isset($lc->sub_caste) ? $lc->sub_caste : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->birth_place) ? $lc->birth_place : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->birth_place_taluka) ? $lc->birth_place_taluka : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->birth_place_dist) ? $lc->birth_place_dist : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->birth_place_state) ? $lc->birth_place_state : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->birth_place_country) ? $lc->birth_place_country : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->dob) ? \Carbon\Carbon::parse($lc->dob)->format('d-m-Y') : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->birth_in_text) ? $lc->birth_in_text : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->previous_school) ? $lc->previous_school : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->standard) ? $lc->standard : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->date_of_admission) ? \Carbon\Carbon::parse($lc->date_of_admission)->format('d-m-Y') : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->academic_progress) ? $lc->academic_progress : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->behavior) ? $lc->behavior : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->comments) ? $lc->comments : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->certificate_date) ? $lc->certificate_date : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->certificate_month) ? $lc->certificate_month : 'N/A' }}</td>-->
                <!--<td>{{ isset($lc->certificate_year) ? $lc->certificate_year : 'N/A' }}</td>-->
                <td>

                    <a href="{{ route('lc.edit' ,$lc->id ) }}" class="btn btn-primary btn-sm">Edit</a>
<button class="btn btn-sm btn-success viewCategory my-3 " data-id="{{ $lc->id }}">
    <i class="fa fa-eye"></i> View
</button>
<a href="#" class="btn btn-danger btn-sm remove-item-btn" data-id="{{ $lc->id }}" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Delete</a>
<!-- Button to Print -->
<a href="{{ route('lc.print', $lc->id) }}" class="btn btn-warning btn-sm" target="_blank" onclick="openAndPrintPage(event, '{{ route('lc.print', $lc->id) }}')">Print</a>
