...
return [
    ...
    "widgets"=>"Widgets",
    "forms"=>"Forms",
    "basic-elements"=>"Create Gharpatti Panipatti",
    "basic-elements2"=>"Update Gharpatti Panipatti",
    ...
    "grid-js"=>"Grid Js",
    "list-js"=>"Gharpatti Panipatti ",
     "list-js2"=>"About Gram",
     "list-js3"=>"Gram Population",
         "list-js4"=>"Create Gram Bills ",
     "list-js5"=>"Update Gram Bills",
     "list-js6"=>"Gram Bills",
        "list-js7"=>"Annual Maintenance",
     "list-js8"=>"Create Annual Maintenance",
     "list-js9"=>"Update Annual Maintenance",
    "category"=>"Gram Category",
    "Grams"=>"Grams",
    "taluka"=>"Taluka",
    'Register-to-gram' =>"Register To Gram",
