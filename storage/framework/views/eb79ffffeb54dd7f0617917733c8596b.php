        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('bonafid.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row gy-4">
        <!-- Row 1 -->
        <div class="col-md-4">
...
unset($__errorArgs, $__bag); ?>
 ...
 <div class="col-md-4">
            ...
            <select class="form-control <?php $__errorArgs = ['school_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="school_address" name="school_address">
...
unset($__errorArgs, $__bag); ?>" id="student_name" name="student_name" placeholder="Enter Student Name" value="<?php echo e(old('student_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="general_register_number" name="general_register_number" placeholder="General Register Number" value="<?php echo e(old('general_register_number')); ?>" maxlength="12" >
...
unset($__errorArgs, $__bag); ?>" id="religion" name="religion" placeholder="Religion" value="<?php echo e(old('religion')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="caste" name="caste" placeholder="Caste" value="<?php echo e(old('caste')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="birth_place" name="birth_place" placeholder="Birth Place" value="<?php echo e(old('birth_place')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="birth_place_taluka" name="birth_place_taluka" placeholder="Birth Place Taluka" value="<?php echo e(old('birth_place_taluka')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="birth_place_dist" name="birth_place_dist" placeholder="Birth Place District" value="<?php echo e(old('birth_place_dist')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="certificate_issued_date" name="certificate_issued_date" placeholder="Date of Certificate Issued" value="<?php echo e(old('certificate_issued_date') ?: now()->toDateString()); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="principal_signature" name="principal_signature" placeholder="Principal's Signature" value="<?php echo e(old('principal_signature')); ?>" >-->
...
<script>
    $(document).ready(function() {
        ...
        if (selectedSchoolId) {
            $.ajax({
                url: '<?php echo e(route('schools.getAddress')); ?>',
                type: 'GET',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/actthgku/general-register.actthost.com/resources/views/bonafid/create.blade.php ENDPATH**/ ?>