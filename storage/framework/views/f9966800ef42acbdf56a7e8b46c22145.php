<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.list-js6'); ?>
                                ...
                                <tbody class="list form-check-all">
                                    <?php $__currentLoopData = $gramBills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($record->quatation_date); ?></td>
                                            <td><?php echo e($record->bill_date); ?></td>
                                            <td><?php echo e($record->reference_number); ?></td>
                                            <td><?php echo e($record->maintenance_amount); ?></td>
                                            <td> 
                                            <button type="button" class="btn btn-sm btn-info view-description-btn" 
                        data-description="<?php echo e($record->description); ?>" 
                        data-bs-toggle="modal" 
                        data-bs-target="#descriptionModal">
                       <i data-feather="eye"></i>
                    </button></td>
                                            <td>
                                                <span class="badge bg-success-subtle text-success text-uppercase"><?php echo e($record->payment_mode); ?></span></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/actthgku/general-register.actthost.com/resources/views/gram-bills/index.blade.php ENDPATH**/ ?>