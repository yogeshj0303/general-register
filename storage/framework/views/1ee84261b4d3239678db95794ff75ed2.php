<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <script>document.write(new Date().getFullYear())</script> © E Gram - Developed & Managed By TUSHAR  SURYAWANSHI  MANAGEMENT
            </div>
...
</script><?php /**PATH /home/egram/public_html/resources/views/layouts/footer.blade.php ENDPATH**/ ?>