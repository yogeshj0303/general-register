  ...
  function printAffidavit(userId) {
        ...
        <div class="col-xxl-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('register-to-gram.store')); ?>" method="POST"  id="registerForm"  class="row g-3" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
...
<!-- Gram Name -->
<div class="col-md-12 mb-3">
    <label for="viewGram" class="form-label">Gram Name</label>
...
<script>
    ...
    function checkSubmitUploadStatus() {
        const isUploading = fileUploads.some(upload => upload.isUploading);
        if (!isUploading) {
            enableSubmitButton();
        }
    }
...
<script>
    ...
    function checkUpdateUploadStatus() {
        const isUploading = fileUploadsEdit.some(upload => upload.isUploading);
        if (!isUploading) {
            enableUpdateButton();
        }
    }
...
document.getElementById('registerForm').addEventListener('submit', function (e) {
    ...
    if (!gram.value) {
        isValid = false;
        errorMessage = 'Please select a gram.';
