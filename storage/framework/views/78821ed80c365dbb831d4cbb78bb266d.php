...
<body>
    ...
    <div class="container">
        ...
        <h1 class="page-title">ABOUT GRAM REPORT</h1>
                ...
                <h1 class="username" style="font-family: 'noto-sans-devanagari';"><?php echo e($user->gram); ?>  </h1>
<p style="font-size: 1.2rem; line-height: 1.8; text-align: center;">
    <strong style="margin-right: 10px; color: #fff;">State:-</strong> <?php echo e($user->state); ?>

    <strong style="margin: 0 10px; color: #fff;">District:-</strong> <?php echo e($user->district); ?>

    <strong style="margin-left: 10px; color: #fff;">Taluka:-</strong> <?php echo e($user->taluka); ?>
        ...
        <table class="info-table" style="margin-top:40px">
            ...
            <tbody>
                <?php $rowNumber = 1; ?>
                    ...
                    <td>About Gram</td>
                    <td><?php echo e($user->about_gram); ?></td>
                </tr>
...
</html><?php /**PATH /home1/actthgku/e-gram.actthost.com/resources/views/about-gram/about_gramprint.blade.php ENDPATH**/ ?>