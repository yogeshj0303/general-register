    ...
    <div class="row">
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('about-gram.store')); ?>" method="POST" class="row g-3"
        ...
        $(document).ready(function() {
            ...
            $('.editGram').click(function() {
                ...
                $.get('/about-gram/' + id + '/edit', function(data) {
                    ...
                    $('#state').val(data.state).trigger(
                    'change'); // Select state and trigger change for district
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location
                            .reload(); // Reload after closing the success alert
                            }
                        });
                    },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gram-project/resources/views/about-gram/about_gram.blade.php ENDPATH**/ ?>