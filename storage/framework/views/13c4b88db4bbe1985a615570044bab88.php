...
// Update amount type when type or username changes
$('#type, #username').on('change', function () {
    ...
    amountTypeInput.val(''); // Clear previous value

    if (selectedType === 'gharpatti') {
        amountTypeInput.val(gharpattiAnnual || ''); // Set gharpatti_annual if available
    } else if (selectedType === 'panipatti') {
        amountTypeInput.val(panipattiAnnual || ''); // Set panipatti_annual if available
    }
});
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gram-project/resources/views/gharpatti-panipatti/create.blade.php ENDPATH**/ ?>