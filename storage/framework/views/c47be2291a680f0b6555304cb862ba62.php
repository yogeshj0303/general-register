...
<body>
 ...
 <div class=""  style="margin-top:-10px; font-size:13px">
        <span style=margin-left:20px>Export Date And Time : <?php echo e($exportDate); ?></span> 
        <span class="right" style="margin-left:100px"><?php echo e($currentUrl); ?></span>
        ...
        <div style="padding: 10px 10px;">
            <div style="font-size: 20px; font-weight: bold; text-align: center; margin-top:-10px; font-family: 'Source Sans Pro', sans-serif;" >
                Invoice No. <?php echo e($record->invoice_no); ?>

            </div>
            <div style="display: flex; font-size: 12px; float:right; ">
                   <div style="margin-right: -20px;">
                       <!--<div style="margin-bottom: 15px; margin-right:25px; color: #333;font-size:15px; font-family: 'Source Sans Pro', sans-serif;"><b>Quotation Date</b> - <?php echo e($record->quatation_date); ?></div>-->
                        <div style="margin-bottom: 7px; color:#333; font-size:15px; font-family: 'Source Sans Pro', sans-serif;">
                               <b>Bill Date</b>: <?php echo e(\Carbon\Carbon::parse($record->bill_date)->format('d-m-y')); ?>

                          </div>

                        <!--<div style="margin-bottom: color: green; 7px;color: #333; font-size:15px; font-family: 'Source Sans Pro', sans-serif;"><b>Reference Billing No.</b> <?php echo e($record->reference_number); ?></div>-->
                        <div style="color: #155402; font-weight: bold; font-size:15px; font-family: 'Source Sans Pro', sans-serif; margin-bottom:7px "><b>Reference Billing No.</b> <?php echo e($record->reference_number); ?></div>
                    </div>
                </div>
        </div>
        ...
        <div style="padding: 10px 20px; font-size: 14px; text-align: left; margin-top:-100px; margin-left:-20px">
            <div>
                ...
                <span style=" font-size: 28px; color: #7b1fa2; font-weight: bold font-family: 'Source Sans Pro', sans-serif , 'noto-sans-devanagari';"><?php echo e($record->gram); ?></span>
            </div>
            <div style="font-size: 14px; color: #333; margin-top: 5px; font-family: 'Source Sans Pro', sans-serif , 'noto-sans-devanagari';">
                Tal- <?php echo e($record->taluka); ?> Dist-<?php echo e($record->district); ?>.
            </div>
        </div>
    ...
    <span style="position: absolute; left: 50%; transform: translateX(-50%); margin-top:-5px;margin-left:-35px">DETAILS</span>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(\Carbon\Carbon::parse($record->next_maintenance_date)->format('d-m-y')); ?></td>
                </tr>
                <tr>
                    <td><?php echo e($rowNumber++); ?></td>
                    <td>Bill Status</td>
        ...
        <table class="info-table single-header">
            <thead>
                <tr>
                    <th colspan="2">GRAM ANNUAL MAINTENANCE</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <div class="bottom-image" style="margin-top:0px; position:relative;">
            <img src="<?php echo e(public_path('build/images/footer.png')); ?>" alt="Bottom Image">
...
<?php /**PATH /home1/actthgku/e-gram.actthost.com/resources/views/annual-maintenance/Annual_print.blade.php ENDPATH**/ ?>