...
unset($__errorArgs, $__bag); ?>" id="user_type" name="user_type">
                                        ...
                                        <option value="Gram_Sevak" <?php echo e(old('user_type') == 'Gram_Sevak' ? 'selected' : ''); ?>>Gram Sevak</option>
                                        <option value="Clark" <?php echo e(old('user_type') == 'Clark' ? 'selected' : ''); ?>>Clark</option>
                                        <option value="Sarpanch" <?php echo e(old('user_type') == 'Sarpanch' ? 'selected' : ''); ?>>Sarpanch</option>
                                        <option value="Sadsy" <?php echo e(old('user_type') == 'Sadsy' ? 'selected' : ''); ?>>Sadsy</option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gram-project/resources/views/users/create.blade.php ENDPATH**/ ?>