...
unset($__errorArgs, $__bag); ?>" id="student_id" name="student_id" placeholder="Enter Student ID" value="<?php echo e(old('student_id')); ?>" maxlength="20">
...
unset($__errorArgs, $__bag); ?>" id="adhar_number" name="adhar_number" placeholder="Enter Aadhar Number" value="<?php echo e(old('adhar_number')); ?>" maxlength="12" >
...
unset($__errorArgs, $__bag); ?>" id="student_name" name="student_first_name" placeholder="First Name" value="<?php echo e(old('student_first_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="student_middle_name" name="student_middle_name" placeholder="Middle Name" value="<?php echo e(old('student_middle_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="student_last_name" name="student_last_name" placeholder="Last Name" value="<?php echo e(old('student_last_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="mother_name" name="mother_name" placeholder="Enter Full Name" value="<?php echo e(old('mother_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="nationality" name="nationality" placeholder="Enter Nationality" value="<?php echo e(old('nationality')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="mother_tongue" name="mother_tongue" placeholder="Enter Mother Tongue" value="<?php echo e(old('mother_tongue')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="religion" name="religion" placeholder="Enter Religion" value="<?php echo e(old('religion')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="caste" name="caste" placeholder="Enter Caste" value="<?php echo e(old('caste')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="sub_caste" name="sub_caste" placeholder="Enter Sub-caste" value="<?php echo e(old('sub_caste')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birth_place" name="birth_place" placeholder="Enter Birth Place" value="<?php echo e(old('birth_place')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birth_place_taluka" name="birth_place_taluka" placeholder="Enter Taluka" value="<?php echo e(old('birth_place_taluka')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birth_place_dist" name="birth_place_dist" placeholder="Enter District" value="<?php echo e(old('birth_place_dist')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birth_place_state" name="birth_place_state" placeholder="Enter State" value="<?php echo e(old('birth_place_state')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="birth_place_country" name="birth_place_country" placeholder="Enter Country" value="<?php echo e(old('birth_place_country')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="dob" name="dob" value="<?php echo e(old('dob')); ?>" onchange="updateDateInText()">
    <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="previous_school" name="previous_school" placeholder="Enter Previous School" value="<?php echo e(old('previous_school')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="standard" name="standard" placeholder="Enter Standard" value="<?php echo e(old('standard')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="date_of_admission" name="date_of_admission" value="<?php echo e(old('date_of_admission')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
        ...
        rows="3" 
        data-char-limit="100" 
        oninput="countCharacters(this)"><?php echo e(old('academic_progress')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
              ...
              rows="3" 
              data-char-limit="100" 
              oninput="countCharacters(this)"><?php echo e(old('behavior')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
              ...
              rows="3" 
              data-char-limit="100" 
              oninput="countCharacters(this)"><?php echo e(old('date_of_leaving_school')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
              ...
              rows="3" 
              data-char-limit="100" 
              oninput="countCharacters(this)"><?php echo e(old('other_studies')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
              ...
              rows="3" 
              data-char-limit="100" 
              oninput="countCharacters(this)"><?php echo e(old('reason_for_leaving_school')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
              ...
              rows="3" 
              data-char-limit="100" 
              oninput="countCharacters(this)"><?php echo e(old('comments')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="certificate_date" name="certificate_date">
        <option value="">Select Date</option>
        <?php for($i = 1; $i <= 31; $i++): ?>
            <option value="<?php echo e($i); ?>" <?php echo e(old('certificate_date') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
        <?php endfor; ?>
    </select>
...
unset($__errorArgs, $__bag); ?>" id="certificate_month" name="certificate_month">
        ...
        <?php $__currentLoopData = [
            ...
            <option value="<?php echo e($index + 1); ?>" <?php echo e(old('certificate_month') == $index + 1 ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="certificate_year" name="certificate_year">
        <option value="">Select Year</option>
        <?php for($year = 2001; $year <= date('Y'); $year++): ?>
            <option value="<?php echo e($year); ?>" <?php echo e(old('certificate_year') == $year ? 'selected' : ''); ?>><?php echo e($year); ?></option>
        <?php endfor; ?>
    </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <!--    <input type="text" class="form-control <?php $__errorArgs = ['teacher_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="teacher_signature" name="teacher_signature" placeholder="Teacher's Signature (with OTP)" value="<?php echo e(old('teacher_signature')); ?>">-->
        <!--    <?php $__errorArgs = ['teacher_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>-->
...
unset($__errorArgs, $__bag); ?>-->
        ...
        <!--    <input type="text" class="form-control <?php $__errorArgs = ['writer_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="writer_signature" name="writer_signature" placeholder="Writer's Signature (with OTP)" value="<?php echo e(old('writer_signature')); ?>">-->
        <!--    <?php $__errorArgs = ['writer_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>-->
...
unset($__errorArgs, $__bag); ?>-->
        ...
        <!--    <input type="text" class="form-control <?php $__errorArgs = ['principal_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="principal_signature" name="principal_signature" placeholder="Principal's Signature (with OTP)" value="<?php echo e(old('principal_signature')); ?>">-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/actthgku/general-register.actthost.com/resources/views/LC/create.blade.php ENDPATH**/ ?>