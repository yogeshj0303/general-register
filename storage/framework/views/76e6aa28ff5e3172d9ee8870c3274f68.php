...
<!-- ========== App Menu ========== -->
  ...
  <?php if((isset($permissions)) && (
                ($permissions['p_w_bill_add'] == 2) || ($permissions['p_w_bill_edit'] == 2) || ($permissions['p_w_bill_delete'] == 2) || ($permissions['p_w_bill_viewown'] == 2) || ($permissions['p_w_bill_viewall'] == 2) ||($permissions['p_w_bill_print'] == 2) 
              ) ): ?>
              
               <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('gharpatti-panipatti.index')); ?>" >
                        <i class="bx bx-doughnut-chart"></i> <span>Property Annual/ Water Annual Bills</span>
                    </a>
                ...
                <?php endif; ?>
                 ...
                 <?php if((isset($permissions)) && (
                ($permissions['about_gram_add'] == 2) || ($permissions['about_gram_edit'] == 2) || ($permissions['about_gram_delete'] == 2) || ($permissions['about_gram_viewown'] == 2) || ($permissions['about_gram_viewall'] == 2) ||($permissions['about_gram_print'] == 2) 
              ) ): ?>
              ...
              <li class="nav-item">
               ...
               <?php if((isset($permissions)) && (
                ($permissions['population_add'] == 2) || ($permissions['population_edit'] == 2) || ($permissions['population_delete'] == 2) || ($permissions['population_viewown'] == 2) || ($permissions['population_viewall'] == 2) ||($permissions['population_print'] == 2) 
              ) ): ?>
                <li class="nav-item">
...
<?php /**PATH /home1/actthgku/e-gram.actthost.com/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>