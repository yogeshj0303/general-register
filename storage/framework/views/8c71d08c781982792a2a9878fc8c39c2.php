                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                       ...
                                       <select id="categoryDropdown" name="category_id" class="form-select js-example-basic-single">
                                ...
                                <h4 class="fs-22 fw-semibold ff-secondary mb-4" style="margin-top:12px">
                                    <span id="categoryCount" class="text-primary"><?php echo e($getRegisterGram); ?></span>
                                </h4>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/actthgku/e-gram.actthost.com/resources/views/index.blade.php ENDPATH**/ ?>