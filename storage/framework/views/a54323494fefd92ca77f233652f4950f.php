    ...
    <div class="container">
        ...
        <div class="print-group">
            ...
            <div class="header-info">
                <h1 class="username" style="font-family: 'noto-sans-devanagari';"><?php echo e($data->gram); ?></h1>
<p style="font-size: 1.2rem; line-height: 1.8; text-align: center;">
    <strong style="margin-right: 10px; color: #fff;">State:-</strong> <?php echo e($data->state); ?>

    <strong style="margin: 0 10px; color: #fff;">District:-</strong> <?php echo e($data->district); ?>

    <strong style="margin-left: 10px; color: #fff;">Taluka:-</strong> <?php echo e($data->taluka); ?>

</p>

            </div>

            <?php if($data->type == 'gharpatti'): ?>
            ...
            <table class="info-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        <td>Type</td>
                        <td><?php if($data->type == 'gharpatti'): ?> Property Annual Taxation <?php else: ?> Water Annual Taxation <?php endif; ?></td>
                    </tr>
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        <td>Annual Amount</td>
                        <td><?php echo e($data->amount_type); ?></td>
                    </tr>
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        <td>Paid Type</td>
                        <td><?php echo e($data->paid_type); ?></td>
                    </tr>
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        <td>Paid Amount</td>
                    ...
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        <td>Paid Date</td>
                        <td><?php echo e($data->paid_date); ?></td>
                    </tr>
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        <td>Remaining Amount</td>
                        <td><?php echo e($data->remaining_amount); ?></td>
                    </tr>
                    <tr>
                        <td><?php echo e($rowNumber++); ?></td>
                        ...
                        <td>
    <?php if($data->type == 'gharpatti'): ?>
        <?php echo e($gharpattiPending >= 0 ? $gharpattiPending : 0); ?>

    <?php elseif($data->type == 'panipatti'): ?>
        <?php echo e($panipattiPending >= 0 ? $panipattiPending : 0); ?>
...
<?php /**PATH /home1/actthgku/e-gram.actthost.com/resources/views/gharpatti-panipatti/gharpattiprint.blade.php ENDPATH**/ ?>