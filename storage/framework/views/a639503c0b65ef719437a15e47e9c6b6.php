...
<script>
  function printAffidavit(userId) {
    ...
    <div class="card">
        ...
        <div class="card-body">
<form action="<?php echo e(route('grams.store')); ?>" method="POST" class="row g-3" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
               <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>">
            ...
            <?php $__currentLoopData = $statesData['states']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($state['state']); ?>" <?php echo e(old('state') == $state['state'] ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="gram_name" value="<?php echo e(old('gram_name')); ?>" placeholder="Enter Gram Name">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="pin_code" class="form-control" id="pincode" value="<?php echo e(old('pin_code')); ?>" placeholder="Enter Pin Code">
...
<div class="col-md-6 mb-3">
    ...
    <input type="text" name="school_contact_no" class="form-control" id="school_contact_no" 
        value="<?php echo e(old('school_contact_no')); ?>" placeholder="Enter School Contact No" 
        maxlength="10" onkeypress="return isNumber(event)">
    <?php $__errorArgs = ['school_contact_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<script>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="school_gmail" class="form-control" id="school_gmail" value="<?php echo e(old('school_gmail')); ?>" placeholder="Enter School Gmail">
        <?php $__errorArgs = ['school_gmail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-12">
        ...
        <textarea name="address" id="address" class="form-control" rows="2" placeholder="Enter Address"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="school_gram_no" class="form-control" id="school_gram_no" value="<?php echo e(old('school_gram_no')); ?>" placeholder="Enter School Grant Number">
        <?php $__errorArgs = ['school_gram_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="school_management" class="form-control" id="school_management" value="<?php echo e(old('school_management')); ?>" placeholder="Enter School Management">
        <?php $__errorArgs = ['school_management'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="school_level" class="form-control" id="school_level" value="<?php echo e(old('school_level')); ?>" placeholder="Enter School Level">
        <?php $__errorArgs = ['school_level'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="school_udash_no" class="form-control" id="school_udash_no" value="<?php echo e(old('school_udash_no')); ?>" placeholder="Enter School UDASH Number">
        <?php $__errorArgs = ['school_udash_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="school_board" class="form-control" id="school_board" value="<?php echo e(old('school_board')); ?>" placeholder="Enter School Board">
        <?php $__errorArgs = ['school_board'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <div class="col-md-12 mb-3" id="dynamic-fields">
        <div class="row mb-2" id="row-1">
            <div class="col-md-4">
                ...
                <input type="text" name="class_name[]" class="form-control" id="class_name_1" value="<?php echo e(old('class_name.0')); ?>" placeholder="Enter Class Name">
                <?php $__errorArgs = ['class_name.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="class_teacher_name[]" class="form-control" id="class_teacher_name_1" value="<?php echo e(old('class_teacher_name.0')); ?>" placeholder="Enter Class Teacher Name">
                <?php $__errorArgs = ['class_teacher_name.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="whatsapp_no[]" class="form-control" id="whatsapp_no_1" value="<?php echo e(old('whatsapp_no.0')); ?>" placeholder="Enter Whatsapp No">
                <?php $__errorArgs = ['whatsapp_no.0'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="row mb-2" id="principal-details">
    <div class="col-md-4">
        ...
        <input type="text" name="principal_name" class="form-control" id="principal_name" placeholder="Enter Principal Name" value="<?php echo e(old('principal_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="principal_type" class="form-control" id="principal_type" placeholder="Enter Principal Type" value="<?php echo e(old('principal_type')); ?>">
        <?php $__errorArgs = ['principal_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-4">
        ...
        <input type="number" name="principle_whatsapp_no" class="form-control" id="principal_whatsapp_no" placeholder="Enter Principal Whatsapp No" value="<?php echo e(old('principle_whatsapp_no')); ?>">
        <?php $__errorArgs = ['principle_whatsapp_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<div class="row mb-2" id="clerk-details">
    <div class="col-md-4">
        ...
        <input type="text" name="clerk_name" class="form-control" id="clerk_name" placeholder="Enter Clerk Name" value="<?php echo e(old('clerk_name')); ?>">
        <?php $__errorArgs = ['clerk_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-4">
        ...
        <input type="number" name="clerk_whatspp_no" class="form-control" id="clerk_whatsapp_no" placeholder="Enter Clerk Whatsapp No" value="<?php echo e(old('clerk_whatspp_no')); ?>">
        <?php $__errorArgs = ['clerk_whatspp_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/actthgku/general-register.actthost.com/resources/views/master/gram.blade.php ENDPATH**/ ?>