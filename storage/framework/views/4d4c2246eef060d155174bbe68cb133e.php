...
<body>
    <div class="container">
       <div class="top-header" style="font-size:20px">
            Certificate Number -  <?php echo e($lc->certificate_no); ?> 
        </div><br>
        <div class="watermark">Certificate Number - <?php echo e($lc->certificate_no); ?> </div>
        <div class="header">
         <img src="<?php echo e($lc->grams->school_logo); ?>" alt="School Logo" style="width: 100px; height: 94px; border-radius: 50%; object-fit: cover;">

            <h1>STUDENT LIVING CERTIFICATE</h1>
            <!-- <p style="text-align: right;">Certificate Number - 0001</p> -->
            <div class="header-bottom">
                <p>Date of Certificate Issued- <?php echo e($lc->certificate_date); ?>    <span>Month-  <?php echo e($lc->certificate_month); ?>     </span> <span>Year- <?php echo e($lc->certificate_year); ?>    </span></p>
            </div>
        </div>
        ...
        <div class="table-container">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo e($lc->reason_for_leaving_school); ?></td>
                </tr>
                <tr>
                    <td>25</td>
                    <td style = "font-weight: bold;">Comments (शेरा )</td>
                    <td><?php echo e($lc->comments); ?></td>
                </tr>
            </table>
        </div>
        ...
        <div class="signature">
         ...
         <div class="footer">
            <div style="font-size:16px"> <?php echo e(now()->format('d-m-Y H:i:s')); ?></div>
            <div style="font-size:16px">Certificate Number -  <?php echo e($lc->certificate_no); ?> </div>
        </div>
    </div>
</body>
</html><?php /**PATH /home1/actthgku/general-register.actthost.com/resources/views/LC/lcprint.blade.php ENDPATH**/ ?>