...
<body>
    ...
    <div class="container">
        <h1 class="page-title">POPULATION REPORT</h1>
                    <div class="header-info">
                <h1 class="username" style="font-family: 'noto-sans-devanagari';"><?php echo e($Population->gram); ?></h1>
<p style="font-size: 1.2rem; line-height: 1.8; text-align: center;">
    <strong style="margin-right: 10px; color: #fff;">State:-</strong> <?php echo e($Population->state); ?>

    <strong style="margin: 0 10px; color: #fff;">District:-</strong> <?php echo e($Population->district); ?>

    <strong style="margin-left: 10px; color: #fff;">Taluka:-</strong> <?php echo e($Population->taluka); ?>
        ...
        <table class="info-table" style="margin-top:40px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>population</td>
                    <td><?php echo e($Population->population); ?></td>
                </tr>
                <tr>
                    <td><?php echo e($rowNumber++); ?></td>
                    <td>year</td>
                    <td><?php echo e($Population->year); ?></td>
                </tr>
                <tr>
                    <td><?php echo e($rowNumber++); ?></td>
                    <td>Confirm by</td>
                    <td> <?php $confimed_name=DB::table('users')->where('id',$Population->confirm_by)->first();
...
</html><?php /**PATH /home1/actthgku/e-gram.actthost.com/resources/views/population/population_print.blade.php ENDPATH**/ ?>